...
\author[1,*]{\fontsize{10pt}{10pt}\selectfont \textbf{Santiago Palacios}}
\author[1]{\textbf{Angie Tobar}}
\author[1]{\textbf{Alejandro Pardo}}

\affil[1]{
\fontsize{8pt}{8pt}\selectfont Pregrado, Universidad Externado de Colombia, Bogotá}
\affil[*]{santiago.palacios@uexternado.edu.co}
